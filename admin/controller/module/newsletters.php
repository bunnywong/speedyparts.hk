...
class ControllerModuleNewsletters extends Controller {
	...
	public function index() {
		$this->load->language('module/newsletters');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/newsletters', 'token=' . $this->session->data['token'], 'SSL')
		);
		...
		$data['action'] = $this->url->link('module/newsletters', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('module/newsletters.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/newsletters')) {
